...
namespace MusicStoreAngularjsMVCApp
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser, long>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<ApplicationUser, ApplicationRole, long, ApplicationUserLogin, ApplicationUserRole, ApplicationUserClaim>(context.Get<ApplicationDbContext>()));
    ...
    {
        public ApplicationRoleManager(RoleStore<ApplicationRole, long, ApplicationUserRole> store) : base(store)
        {
        }

        public static ApplicationRoleManager Create(IdentityFactoryOptions<ApplicationRoleManager> options, IOwinContext context)
        {
            var a = new RoleStore<ApplicationRole, long, ApplicationUserRole>(context.Get<ApplicationDbContext>());
            return new ApplicationRoleManager(a);
        }
    }
}
